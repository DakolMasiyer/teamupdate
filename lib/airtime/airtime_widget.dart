    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'yxp736wc' /* Pay Electricity Bills safely, ... */,
                        ),
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown(
                        options: [
                          FFLocalizations.of(context).getText(
                            's5b6yacr' /* Internal Transfer */,
                          ),
                          FFLocalizations.of(context).getText(
                            'q0gd4hp2' /* External Transfer */,
                          ),
                          FFLocalizations.of(context).getText(
                            '25r6y25q' /* ACH Payment */,
                          )
                        ],
          ...
          Text(
            FFLocalizations.of(context).getText(
              'x063svys' /* Tap above to complete Payment */,
            ),
