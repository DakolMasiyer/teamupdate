            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (!(Theme.of(context).brightness == Brightness.dark))
                    Image.asset(
                      'assets/images/e-naira-logo.png',
                      width: 60,
                      height: 60,
                      fit: BoxFit.fitWidth,
                    ),
                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'hxtwax0y' /* Send and Receive Funds instant... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'uf9k1spp' /* Easily pay for your Utility Bi... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
