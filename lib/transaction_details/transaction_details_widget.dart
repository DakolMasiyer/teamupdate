  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BudgetsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final transactionDetailsBudgetsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                              ...
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0, 4, 0, 0),
                                  child: Text(
                                    transactionDetailsBudgetsRecord.budetName!,
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  formatNumber(
                                    transactionDetailsBudgetsRecord
                                        .budgetAmountNumber!,
                            ...
                            children: [
                              Text(
                                valueOrDefault<String>(
                                  transactionDetailsBudgetsRecord.budgetTime,
                                  '4 Days Left',
                                ),
                    ...
                    stream: queryTransactionsRecord(
                      queryBuilder: (transactionsRecord) =>
                          transactionsRecord.where('budgetAssociated',
                              isEqualTo:
                                  transactionDetailsBudgetsRecord.reference),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                          ...
                          queryBuilder: (transactionsRecord) =>
                              transactionsRecord
                                  .where('budgetAssociated',
                                      isEqualTo: transactionDetailsBudgetsRecord
                                          .reference)
